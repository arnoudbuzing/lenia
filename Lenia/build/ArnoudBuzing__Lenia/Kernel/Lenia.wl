BeginPackage["ArnoudBuzing`Lenia`"];
...
LeniaSeed[n_Integer, "Ring"] := NumericArray[leniaSeedRing[n, Max[3, Round[n / 10]]], "Real64"];
LeniaSeed[n_Integer, "MultiRing"] := NumericArray[leniaSeedMultiRing[n, Max[3, Round[n / 10]]], "Real64"];
LeniaSeed[n_Integer, "RandomOrganism"] := NumericArray[leniaSeedRandomOrganism[n, Max[3, Round[n / 10]]], "Real64"];
LeniaSeed[n_Integer, "Constellation"] := NumericArray[leniaSeedConstellation[n, Max[3, Round[n / 10]]], "Real64"];
LeniaSeed[n_Integer, "Asymmetric"] := NumericArray[leniaSeedAsymmetric[n, Max[3, Round[n / 10]]], "Real64"];
...
Lenia[initialGrid : (_?MatrixQ | _NumericArray), steps_Integer, OptionsPattern[]] :=
